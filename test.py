...
def test(output_directory = 'test_output'):
    ...
    focal_surface_filename = os.path.join(output_directory, 'dataset/test/sample_0343_focal_surface.png')
    ...
    # Preparing hologram
    hologram_phases_filename = os.path.join(output_directory, 'dataset/test/sample_0343_hologram.png')
